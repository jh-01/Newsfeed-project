...
/**
 * 게시글(Feed) 관련 DB 접근을 담당하는 Repository 인터페이스입니다.
 * 기본적인 CRUD 기능은 JpaRepository에서 제공되며,
 * 사용자 정의 쿼리 메서드를 추가로 선언할 수 있습니다.
 */
@Repository
public interface FeedRepository extends JpaRepository<Feed, Long> {

    /**
     * 특정 사용자가 작성한 게시글 목록을 생성일 기준으로 내림차순 정렬하여 반환합니다.
     *
     * @param userId 작성자 ID
    ...
    /**
     * 전체 게시글을 생성일 기준으로 내림차순 정렬하여 반환합니다.
     * 페이지네이션 처리는 Service 단에서 Pageable로 처리합니다.
     */
